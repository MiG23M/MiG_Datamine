...
let optList = [
  ...
  "USEROPT_ALLOW_SHOW_WISHLIST"
  "USEROPT_ALLOW_SHOW_WISHLIST_COMMENTS"
  ...
  "USEROPT_HUD_SHOW_AMMO_TYPE_IN_KILLLOG"
  "USEROPT_HUD_SHOW_SQUADRON_NAMES_IN_KILLLOG"
  "USEROPT_VOLUME_VWS"
  "USEROPT_VOLUME_RWR"
  "USEROPT_CAN_QUEUE_TO_NIGHT_BATLLES"
  "USEROPT_HELI_COCKPIT_HUD_DISABLED"
]
